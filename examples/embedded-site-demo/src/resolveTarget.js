// resolveTarget -- pure, DOM-free target resolution for the embedded-site demo.
...
//
// server / port pass through verbatim (buildStreamConfig validates them and
// throws the "did you forget to configure it?" error on the unsubstituted
// server sentinel). mediaPort is OPTIONAL, so an unsubstituted / empty /
// non-numeric value is sanitized to null (omit + SDP-negotiate, D1).
